...
--- Calculate the average number home and away goals scored Legia Warszawa, 
--- and their opponents, partitioned by the month in each season.
...
--- Generate a list of matches in which Manchester United was
--- defeated during the 2014/2015 English Premier League season.
...
--- Build a query to extract all matches played by
--- Manchester United in the 2014/2015 season.
